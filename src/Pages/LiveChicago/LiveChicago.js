...
window.scrollTo(0,0);
    ...
    <div>
      ...
      />
        ...
        <div className='liveChicagoHeader'>
            <span className='live_Chicage_txt'>LIVE CHICAGO</span>
        </div>
        <div className='liveChicagoDiv'>
