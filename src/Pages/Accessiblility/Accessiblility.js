  ...
  return (
    ...
    <div>
      ...
      />
        ...
        <div className='accessiblilityHeader'>
            <span className='accessiblility_txt'>ACCESSIBILITY</span>
        </div>
        <div className='accessiblilityDiv'>
