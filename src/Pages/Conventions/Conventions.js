    ...
    <div>
      <Header/>
       <Grid container>
           <Grid item md={8} sm={8.5} xs={12}>
             <div className='ConventionsFirstDiv'>
       <BreadCrum
      lst={[ {
        name:'home',
        url:'/'
      ...
      />
         ...
         <span className='footNote'>photograph: shotterstock</span>
            ...
            <h2 style={{fontWeight:'800',marginLeft:'0px',fontSize:35,marginTop:0,marginBottom:0,color:'#333333'}} className='best-thing-heading'>The Best Things To Do In Chicago</h2>
           <hr style={{width:'98%',marginLeft:'0px',height:'10px',backgroundColor:'#3EB2E2'}} className='festival-hr'/>
           <h5 style={{marginLeft:'0px',color:'#8C8C8C',fontWeight:'normal',fontSize:16,marginTop:10,marginBottom:-5}} className='written-by-heading'>Written by:karen R Tuesday 8 febuary 2022</h5>
        
            </Grid>
            <Grid item lg={12} md={12} sm={12} xs={11.5} style={{marginLeft:'0px',marginTop:'20px'}} className='Conventionss-icon' >
              <img src={facebookicon} style={{paddingLeft:'5px'}} className='Conventions-facebook-icon'/>
              <img src={instagramicon} style={{paddingLeft:'5px'}} className='Conventions-instagram-icon'/>
              <img src={TwitterIcon} style={{paddingLeft:'5px'}} className='Conventions-twitter-icon'/>
              <img src={messageicon} style={{paddingLeft:'5px'}} className='Conventions-message-icon'/>
            </Grid>
            <Grid  lg={11} md={11} sm={11} xs={11.5} style={{marginTop:'30px'}}>
            <p style={{color:'#8C8C8C',fontSize:16.3,fontWeight:400}} className='publisher-paragraph'>Headed to Chicago? You've got a lot of ground to cover . This guide breaks down all the best parts of out city, from our  stunning waterfronts to our bustling neighbourhoods to our vibrant theatre district. Don't leave before you check these must-sees off your list.</p>
            </Grid>
            <Grid lg={12} md={8} sm={11} xs={11.5} style={{marginTop:'40px'}}>
               <h2 className='cheerHearing' style={{fontWeight:'700',marginLeft:'0px',color:'#333333',fontSize:28}}>Cheers to the city's craft beer scene</h2>
            </Grid>
            <Grid lg={12} md={11} sm={11} xs={11.5} style={{marginTop:'30px'}}>
            ...
            <Grid lg={12} mt={8} mb={8}  md={11} sm={11} xs={12} style={{marginTop:'30px'}}>
            <p style={{color:'#8C8C8C',fontSize:16.3,fontWeight:400}} className='publisher-paragraph'>Chicago is America's craft beer capital, home to more breweries than any other city in the country. That means no visit is complete without a trip to a local taproom for a coid one (or two).</p>
            </Grid>
           ...
           <Grid item md={4} sm={3.5} xs={12}>
            ...
            <div className='ConventionsSecondFirstMainDIv' style={{height:175,width:'92%',margin:'auto' , background:'#F2F6FF',marginTop:40}}>
              <br/>
              <div className='ConventionsSecondFirstDIv' style={{width:'45%',margin:'auto',height:40,background:'white',marginTop:20,border:'2px solid #D2A4A9',borderRadius:5}}>
                <Grid container pt={1}>
            ...
            <h3 style={{color:'#333333',fontSize:23}}>FEATURED</h3>
                <DotSliders/>

                <h3 className='' style={{marginTop:100,color:'#333333'}}>RECOMMENDED SHOWS</h3>
                <DotSliders/>
                <h3 className='' style={{marginTop:100,color:'#333333',fontSize:23}}>GIVEAWAYS</h3>
                <DotSliders/>
                <h3 className='' style={{marginTop:100,color:'#333333',fontSize:23}}>THIS WEEK</h3>
                <DotSliders/>
